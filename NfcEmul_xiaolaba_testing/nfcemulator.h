...
//////// by xiaolaba
// add port name ,pin name for Analog comparator, used for avr-gcc 4.3.3
#define AIN1_PORT PORTB //attiny84
#define AIN1_BIT 2 // bit2

//////// by xiaolaba
// add function prototype, used for avr-gcc 4.3.3
